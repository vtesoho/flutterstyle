...
class BmsVideoPlayerController {
  ...
  Future<void> testFrame(map) async {
    Timer(Duration(milliseconds: 50), (){
      _channel.invokeMethod('test',{"width":map['width'],"height":map['height']});
    });
    return _channel.invokeMethod('test',{"width":map['width'],"height":map['height']});
  }
